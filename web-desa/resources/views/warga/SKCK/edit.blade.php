...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('skck-update', $skck->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    
                    <div class="form-group">
                        <label for="keperluan">Keperluan <span class="text-danger">*</span></label>
                        <textarea type="text" class="form-control" id="keperluan" name="tujuan" required>{{ old('tujuan', $skck->tujuan) }}</textarea>
                    </div>
