...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('umum-update', $umum->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label for="keperluan">Keperluan <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="keperluan" name="tujuan" required>{{ old('tujuan', $umum->tujuan) }}</textarea>
                    </div>
                    
                    <div class="form-group">
                        <label for="keterangan">Keterangan <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="keterangan" name="keterangan" required>{{ old('keterangan', $umum->keterangan) }}</textarea>
                    </div>
